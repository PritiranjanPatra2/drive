    ...
    return (
      <div className='w-full flex justify-center items-center p-8'>
        <div className='relative w-full'>
          ...
          <button
            onClick={prevSlide}
            className='absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-500 bg-black-500 p-2 rounded-full'
          ...
          <button
            onClick={nextSlide}
            className='absolute right-4 top-1/2 transform -translate-y-1/2  text-gray-500 bg-black-500 p-2 rounded-full'
